...
title = Evenyaru server

# (str) Package name
package.name = server

# (str) Package domain (needed for android/ios packaging)
package.domain = ru.evenya
...
### Added attic
source.exclude_dirs = attic, tests, bin
...
### Turns out we need that (d'Oh)
android.permissions = INTERNET

# (int) Android API to use
#android.api = 19
### See https://code.google.com/p/android/issues/detail?id=19854
android.api = 18
...
#android.ndk = 9c
### Use the latest [should even be better at backwards compatibility ;) ]
android.ndk = 10e
